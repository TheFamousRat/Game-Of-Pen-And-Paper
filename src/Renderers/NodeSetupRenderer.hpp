#ifndef NODESETUPRENDERER_HPP_INCLUDED
#define NODESETUPRENDERER_HPP_INCLUDED
...
namespace tgui
{
    class NodeSetupRenderer : public PanelRenderer
    {
    public:
...
#endif // NODESETUPRENDERER_HPP_INCLUDED
